...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 09, 2019 at 08:29 PM
...
CREATE TABLE IF NOT EXISTS `projekti` (
  ...
  `BudgetSpent` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`ID`),
  KEY `ID` (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_latvian_ci;
